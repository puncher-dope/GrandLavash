...
import SelectDrinksSubcategories from "../selectDrinksSubcategories/page";
import SelectSizeSubcategories from "../selectSizeSubcategories/page";
...
import ImageUpload from "../imageUpload/page"; // Добавьте этот импорт
